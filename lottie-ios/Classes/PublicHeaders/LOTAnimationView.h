...
/// Loads animation asynchronously from the specified Zip URL
- (nonnull instancetype)initWithAnimationFromJsonZipUrl:(nonnull NSString *)url complete:(void (^_Nullable)(bool result))unzipLoadSuccess;
