...
- (void)viewDidLoad {
  ...
  self.lottieLogo = [[LOTAnimationView alloc]initWithAnimationFromJsonZipUrl:@"https://otherfiles.uupt.com/User/Image/hallskin/datingtankuang.zip" complete:^(bool result) {
